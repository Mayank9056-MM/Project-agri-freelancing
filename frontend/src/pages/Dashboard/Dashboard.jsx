          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                <div
                  className={`w-10 h-10 rounded-xl flex items-center justify-center bg-gradient-to-br shadow-lg ${
                    isDark
                ...
                <div className="hidden sm:block">
                  <span
                    className={`text-xl font-bold block bg-gradient-to-r ${
                      isDark
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <Card
                  className={`lg:col-span-2 border-0 ${
                    isDark ? "bg-gray-900 shadow-2xl" : "bg-white shadow-xl"
                  }`}
                >
                  <CardHeader>
                    <CardTitle
                  ...
                  <CardContent className="space-y-4">
                    ...
                    >
                      <p className={isDark ? "text-gray-400" : "text-gray-600"}>
                        Cart is empty. Scan or add products to begin.
                      </p>
                    </div>
                  </CardContent>
                </Card>
