...
const ProductList = ({ onEdit, onDelete, onView }) => {
  ...
  const categories = ["all", "Electronics", "Audio", "Accessories", "Cables", "Computers", "Peripherals", "Storage", "Networking"];
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  >
                    {product.image ? (
                      ...
                      <Package className={`h-8 w-8 ${isDark ? "text-violet-400" : "text-violet-600"}`} />
                    )}
                  </div>
                  <div
                    className={`px-3 py-1 rounded-full text-xs font-semibold border bg-gradient-to-br ${getStatusColor(
